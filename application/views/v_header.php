...
<head>
    ...
    <?php if($this->uri->uri_string() == 'browse' || 'search') {
    echo '
        <link rel="preconnect" href="http://s18.postimg.org/">
		  <link rel="prefetch" href="' . base_url('assets/js/unveil.js') . '">
    ';
    } ?>
